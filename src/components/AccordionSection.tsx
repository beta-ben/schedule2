  ...
  return (
    <section className={[className].filter(Boolean).join(' ')}>
      <button
        type="button"
        className={[
          'w-full flex items-center justify-between gap-3 px-3 py-2 rounded-lg border text-left text-base font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2',
